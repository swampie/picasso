...
ImageMagick.prototype.withGeometry = function(geometry){
		this.options.args.push({'-geometry':geometry});
		return this;
	}
...
ImageMagick.prototype.interlace = function(interlace){
		this.options.args.push({'-interlace':interlace});
		return this;
	}
